...
import npmsRequestAbs from '../../util/npmsRequestAbs';
...
export function fetch(query) {
    return (dispatch, getState) => {
        ...
        dispatch({
            ...
            payload: {
                data: query,
                promise: npmsRequestAbs(`https://api.npms.io/v2/search/suggestions?q=${encodeURIComponent(query)}&size=${maxResults}`),
            },
        })
