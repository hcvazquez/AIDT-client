...
const placeholderSuggestions = [
    ...
    'mobile framework',
    'test framework',
    'socket microservices facilities',
    'promises implementation functions',
];
...
class SearchBox extends Component {
    ...
    componentWillMount() {
        this._placeholder = `Look for technologies like "${placeholderSuggestions[Math.floor(Math.random() * placeholderSuggestions.length)]}"`;
